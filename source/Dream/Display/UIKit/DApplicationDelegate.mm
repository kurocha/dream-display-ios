//
//  Display/UIKit/DApplicationDelegate.mm
...
Dream::Display::IApplication * global_application = NULL;

@implementation DApplicationDelegate

+ (void) startWithApplication: (Dream::Display::IApplication*)application {
